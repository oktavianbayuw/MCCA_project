...
public class AdminAddNewProductActivity extends AppCompatActivity {
    ...
    private void StoreProductInformation()
    {
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            {
                Toast.makeText(AdminAddNewProductActivity.this, "Item Image uploaded Successfully...", Toast.LENGTH_SHORT).show();
                ...
                Task<Uri> urlTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task)
                    {
                        if (task.isSuccessful())
                        {
                            ...
                            Toast.makeText(AdminAddNewProductActivity.this, "got the item image Url Successfully...", Toast.LENGTH_SHORT).show();
